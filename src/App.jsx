...
function emptyForemanAssignment() {
  return {
    localIimport React, { useEffect, useMemo, useState } from 'react'
import { supabase } from './lib/supabase'
      ...
      {activeTab === 'master' && (
        <div style={styles.masterGrid}>
          ...
          <div style={styles.formStack}>
            <div style={styles.smallText}>
              Create text groups and choose which contacts you want included.
            </div>
          ...
          <div style={styles.listWrapTight}>
            {!selectedTextGroupViewId ? (
              <div style={styles.smallText}>Select a text group to view its contacts.</div>
            ) : (() => {
              const selectedGroup = contactGroups.find((group) => group.id === selectedTextGroupViewId)
              const groupContacts = contacts.filter((contact) =>
                (selectedGroup?.contact_group_memberships || []).some(
              ...
              return !selectedGroup ? (
                ...
                <div style={styles.emailGroupBlockCompact}>
                  <div style={styles.emailGroupHeader}>
                    ...
                    <div style={styles.itemButtonRow}>
                      ...
                      <button onClick={() => renameContactGroup(selectedGroup)} style={styles.smallButtonSecondary}>
                        Edit
                      </button>
                      <button onClick={() => deleteContactGroup(selectedGroup.id)} style={styles.smallButtonDanger}>
                        Delete
                      </button>
                    </div>
                  </div>
                  ...
                  {groupContacts.length === 0 ? (
                    ...
                    groupContacts.map((contact) => (
                      <div key={contact.id} style={styles.listItemCompact}>
                        <div style={styles.contactInfoCompact}>
                          <div style={styles.contactNameCompact}>{contact.name}</div>
                          <div style={styles.smallText}>
          ...
          <div style={styles.formStack}>
            <div style={styles.smallText}>
              Create email groups and select contacts with email addresses.
            </div>
          ...
          <div style={styles.listWrapTight}>
            {!selectedEmailGroup ? (
              <div style={styles.smallText}>Select an email group to view its recipients.</div>
            ) : (
              <div style={styles.emailGroupBlockCompact}>
                <div style={styles.emailGroupHeader}>
                  ...
                  <div style={styles.itemButtonRow}>
                    ...
                    <button onClick={() => renameEmailGroup(selectedEmailGroup)} style={styles.smallButtonSecondary}>
                      Edit
                    </button>
                    <button onClick={() => deleteEmailGroup(selectedEmailGroup.id)} style={styles.smallButtonDanger}>
                      Delete
                    </button>
                  </div>
                </div>
                ...
                {!selectedEmailGroup.email_group_recipients?.length ? (
                  <div style={styles.smallText}>No recipients in this group yet.</div>
                ) : (
                  selectedEmailGroup.email_group_recipients.map((recipient) => (
                    <div key={recipient.id} style={styles.listItemCompact}>
                      <div style={styles.contactInfoCompact}>
                        <div style={styles.contactNameCompact}>{recipient.name || 'No Name'}</div>
                        <div style={styles.smallText}>{recipient.email}</div>
                      </div>
                      <div style={styles.itemButtonRow}>
                        <button onClick={() => deleteRecipient(recipient.id)} style={styles.smallButtonDanger}>
                          Delete
                        </button>
                      </div>
                    </div>
                ...
                <div style={styles.smallText}>Use the checkboxes in Contacts to quickly add or remove saved contacts from this group.</div>
              </div>
            )}
          </div>
        </SectionCard>
